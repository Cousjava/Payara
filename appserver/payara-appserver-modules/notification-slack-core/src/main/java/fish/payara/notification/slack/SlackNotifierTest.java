 ...
 * @author jonathan
 */
public class SlackNotifierTest extends NotifierTest {
    ...
    public LogRecord testNotifier(){
        SlackNotifierService service = habitat.getService(SlackNotifierService.class);
        ...
        event.setMessage("Slack Notifier Test");       
