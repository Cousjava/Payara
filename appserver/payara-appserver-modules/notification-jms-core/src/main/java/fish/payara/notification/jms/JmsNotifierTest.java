 ...
 * @author jonathan
 */
public class JmsNotifierTest extends NotifierTest {
    ...
    public LogRecord testNotifier(){
        JmsNotifierService service = habitat.getService(JmsNotifierService.class);
        ...
        event.setMessage("JMS Notifier Test");       
